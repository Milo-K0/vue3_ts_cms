    ...
    <div class="table">
      <el-table :data="pageList" border style="width: 100%">
        ...
        <el-table-column
          ...
          align="center"
        ></el-table-column>
        <el-table-column label="上级部门" width="110px" align="center">
...
import type PageModal from './page-modal.vue'
import { useMainStore } from '@/store/main/main'
import { mapDepartmentIdToName } from '@/utils/map-manus'
...
const parentName = (id: number | undefined) => {
  if (!id || !entreDepartments.value) return '无'
  return mapDepartmentIdToName(id, entreDepartments.value)
}
